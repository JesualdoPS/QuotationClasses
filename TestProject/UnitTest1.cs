...
namespace TestProject
{
    ...
    public class UnitTest1
    {
        ...
        public void ShouldThrowExceptionWhenUnsupportedOperatorSymbolIsUsed()
        {
            ...
            // Act e Assert
            Assert.ThrowsException<NotImplementedException>(() => calculator.Calculate("12 m : 2 m "));
        }
        ...
        public void ShouldThrowExceptionWhenUnsupportedOperatorSymbolIsUsed_Millimeter()
        {
            ...
            // Act e Assert
            Assert.ThrowsException<NotImplementedException>(() => calculator.Calculate("12 mm : 2 mm"));
        }
        [TestMethod]
        public void ShouldThrowExceptionWhenUnsupportedOperatorSymbolIsUsed_NotationWithoutSpaces()
        {
            ...
            // Act e Assert
            Assert.ThrowsException<NotImplementedException>(() => calculator.Calculate("12m:2m"));
        }
        ...
        public void ShouldThrowExceptionWhenUnsupportedOperatorSymbolIsUsed_Millimeter_NotationWithoutSpaces()
        {
            ...
            // Act e Assert
            Assert.ThrowsException<NotImplementedException>(() => calculator.Calculate("12mm:2mm"));
        }
        ...
        [TestMethod]
        public void ShouldConvertIQuantityResultToString_Meters()
        {
            //Arrange
            var mathLog = new MathLog
            {
                Math = "15 m + 5 m",
                Result = Length.FromMeters(20)
            };

            //Act
            var result = mathLog.ResultToString();

            //Assert
            result.Should().Be("20 m");
        }

        [TestMethod]
        public void ShouldConvertIQuantityResultToString_SquareMeters()
        {
            //Arrange
            var mathLog = new MathLog
            {
                Math = "15 m * 5 m",
                Result = Area.FromSquareMeters(75)
            };
            ...
            //Assert
            result.Should().Be("75 m²");
        }

        [TestMethod]
        public void ShouldConvertIQuantityResultToString_Millimeters()
        {
            //Arrange
            var mathLog = new MathLog
            {
                Math = "15 mm + 5 mm",
                Result = Length.FromMillimeters(20)
            };
            ...
            //Assert
            result.Should().Be("20 mm");
        }

        [TestMethod]
        public void ShouldConvertIQuantityResultToString_SquareMillimeters()
        {
            //Arrange
            var mathLog = new MathLog
            {
                Math = "15 mm * 5 mm",
                Result = Area.FromSquareMillimeters(75)
            };
            ...
            //Assert
            result.Should().Be("75 mm²");
        }

        [TestMethod]
        public void FromStringReturnStringToMeters()
        {
            // Arrange
            var math = "15 m + 5 m";
            var result = "20 m";
            ...
            // Act
            var mathLog = MathLog.FromString(math, result);

            // Assert
            mathLog.Math.Should().Be(math);
            mathLog.Result.Should().BeOfType<Length>();
            ((Length)mathLog.Result).Value.Should().Be(20);
        }

        [TestMethod]
        public void FromStringReturnStringToMillimeters()
        {
            // Arrange
            var math = "15 mm + 5 mm";
            var result = "20 mm";
        ...
        [TestMethod]
        public void FromStringReturnStringToSquareMeters()
        {
            // Arrange
            var math = "15 m * 5 m";
            var result = "75 m²";
            ...
            // Assert
            mathLog.Math.Should().Be(math);
            mathLog.Result.Should().BeOfType<Area>();
            ((Area)mathLog.Result).Value.Should().Be(75);
        }

        [TestMethod]
        public void FromStringReturnStringToSquareMillimeters()
        {
            // Arrange
            var math = "15 mm * 5 mm";
            var result = "75 mm²";
        ...
        [TestMethod]
        public void ShouldThrowExceptionOnFromString()
        {
            // Arrange
            var math = "15 x + 5 x";
            var result = "20 x";
            ...
            // Act
            var exception = () => MathLog.FromString(math, result);
        ...
        public void ShouldSerializeMathLogToJson()
        {
            ...
            var filePath = @"C:\temp\Calculator.json";
            ...
            // Assert
            loadedCalculator.Memory.Count.Should().Be(mathLogs.Count);
